...
void main(List<String> args) {
  ...
  stdout.writeln(
    'Next: run check script: bash tool/legacy/check_facebook_setup.sh ${appRootDir.path}',
  );
}
...
void _writeIosFiles(
  ...
  fbConfig.writeAsStringSync(
    '''// Generated by company_analytics/tool/legacy/sync_analytics_config.dart
...
Never _usageAndExit(String message) {
  ...
  stderr.writeln(
    '  dart run tool/legacy/sync_analytics_config.dart --app-root <flutter_app_root> --config <yaml_path>',
  );
  exit(2);
}
